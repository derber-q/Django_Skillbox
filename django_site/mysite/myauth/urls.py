...
urlpatterns = [
    ...
    path('user-update/<int:pk>/', ProfileUpdateView.as_view(), name='user-update'),
    ...
    path('foo-bar/', FoobBarView.as_view, name='foo-bar'),
    path('profilelist/', ProfileListView.as_view(), name='profile-list'),
